...
export const useGmail = () => {
  ...
  const clientId =
    "549586616098-u9htbeuk389nctn534oddqp4t3ifhj11.apps.googleusercontent.com"; //"取得してきたクライアントidを入れる";
  const clientSecret = "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"; //"取得してきたクライアントSeacretを入れる";
